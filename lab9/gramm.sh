...
set xlabel 'x'
set ylabel '{/Symbol f}_j(x)'
set grid
plot "gramm.dat" u 1:2 i 0 w l ls 1 t '{/Symbol f}_0(x)' , \
'' u 1:2 i 1 w l ls 2 t '{/Symbol f}_1(x)' , \
'' u 1:2 i 2 w l ls 3 t '{/Symbol f}_2(x)' , \
'' u 1:2 i 3 w l ls 4 t '{/Symbol f}_3(x)' , \
'' u 1:2 i 4 w l ls 5 t '{/Symbol f}_4(x)' , \
'' u 1:2 i 5 w l ls 6 t '{/Symbol f}_5(x)' , \
'' u 1:2 i 6 w l ls 7 t '{/Symbol f}_6(x)'
